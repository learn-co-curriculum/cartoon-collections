...
It should then print out each name preceded by numerical order using `puts`. The print-out should look like this:
...
<p class='util--hide'>View <a href='https://learn.co/lessons/cartoon-collections'>Cartoon Collections</a> on Learn.co and start learning to code for free.</p>
